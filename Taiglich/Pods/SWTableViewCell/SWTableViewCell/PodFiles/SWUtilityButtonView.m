...
- (void)setUtilityButtons:(NSArray *)utilityButtons WithButtonWidth:(CGFloat)width
{
    ...
    if (utilityButtons.count)
    {
        ...
        for (UIButton *button in _utilityButtons)
        {
            ...
            [self addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|[button]|"   options:0L       metrics:nil
        ...
        [self addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"[precedingView]|"     options:0L     metrics:nil
